...
imgBtlBG = pygame.image.load("images/btlbg.png")
imgEffect = pygame.image.load("images/effect_a.png")
imgEnemy = pygame.image.load("images/enemy1.png")
...
def main():
    ...
    pygame.init()
    pygame.display.set_caption("Turn Logic")
