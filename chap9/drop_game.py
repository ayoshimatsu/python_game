...
def game_main():
    ...
    if index == 0:
        draw_txt("Cat cat", 312, 240, 100, "violet", "TITLE")
        ...
        if mouse_x >= 24 and mouse_x < 24 + 72 * 8 \
                and mouse_y >= 24 and mouse_y < 24 + 72 * 10:
    ...
    draw_txt("HIGH : "+str(score), 450, 60, 32, "yellow", "INFO")
